...
export default async function SharePage({ searchParams }: SharePageProps) {
  ...
  return (
    <div className={`max-w-2xl mx-auto space-y-8 pt-12 pb-16 min-h-[70vh] flex flex-col justify-center bg-radial ${theme.bgGlow}`}>
      ...
      <div className={`relative overflow-hidden rounded-3xl border ${theme.border} bg-gray-900/60 p-8 md:p-10 shadow-2xl backdrop-blur-md transition-all duration-300`}>
